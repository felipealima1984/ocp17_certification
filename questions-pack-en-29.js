...
<span class="cls">System</span>.out.println(s.stripTrailing().length());`,
  ...
  },
  {
    ...
    code: `<span class="cls">String</span> a = <span class="str">"""
        ...
        line two
        """</span>;
<span class="cls">String</span> b = <span class="str">"""
        line one\
        line two
        """</span>;
<span class="cls">System</span>.out.println(a.lines().count());
<span class="cls">System</span>.out.println(b.lines().count());`,
    options: ["2
1", "2
2", "1
1", "Compilation error"],
    answer: 0,
    explanation: "a: two content lines separated by \n. lines().count()=2. b: trailing \\ (line continuation escape) on 'line one' suppresses the newline, merging it with 'line two' → single logical line 'line oneline two'. lines().count()=1. Result: '2\n1'."
  },
  {
